...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, type):
        ...
        if type == 'fly':
            fly_1 = pygame.image.load('graphics/fly/C1.png').convert_alpha()
            fly_2 = pygame.image.load('graphics/fly/C2.png').convert_alpha()
            self.frames = [fly_1, fly_2]
            y_pos = 210
        else:
            snail_1 = pygame.image.load('graphics/snail/1.png').convert_alpha()
            snail_2 = pygame.image.load('graphics/snail/2.png').convert_alpha()
            snail_3 = pygame.image.load('graphics/snail/3.png').convert_alpha()
...
pygame.display.set_caption('Star Voyager')
...
sky_surface = pygame.image.load('graphics/skay3.jpg').convert()
ground_surface = pygame.image.load('graphics/skay3.jpg').convert()
...
game_name = test_font.render('Star Voyager', False, (159, 43, 104))
